...
#Note google spreadsheet must be published to the web (googledoc file heading) to generate pubhtml url
url <- "https://docs.google.com/spreadsheets/d/1jgPvqCilrKbs3QhkHvGD2Cb2_qEvfSpXYa3ovScCtzI/pubhtml"
g <- readGoogleSheet(url)
gDataFrame <- cleanGoogleTable(g, table=1) #gDataFrame is a regular R dataframe